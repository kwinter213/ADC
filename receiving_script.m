...
LaurensReal = real(Laurens);
LaurensImag = imag(Laurens);
LaurensRealImag = horzcat(LaurensReal,LaurensImag);
errorRate = errorCalculation(LaurensRealImag,RealImagDecoded);
